...
const DotXDashboard = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <Loader2 className="h-8 w-8 animate-spin text-redmetal-400" />
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="p-6 text-center">
        <h3 className="text-xl font-semibold text-redmetal-400">Error loading DOT-X systems</h3>
  ...
  return (
    <div className="space-y-8 bg-black-900 p-6 rounded-xl">
      <div>
        <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-silver-100 to-silver-300/80 bg-clip-text text-transparent">DOT-X Command Center</h1>
        <p className="text-silver-300/70">Advanced command center with AI agents and neural shield protection</p>
      </div>
