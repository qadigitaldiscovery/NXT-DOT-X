...
const ModuleAutoPage = () => {
  ...
  return (
    <MissingPageTemplate
      ...
      moduleDescription={`This is an auto-generated page for the ${moduleName} module. It provides access to all ${moduleName.toLowerCase()} functionality.`}
      navCategories={navCategories}
      docsLink="/admin/documentation"
    />
  );
};
