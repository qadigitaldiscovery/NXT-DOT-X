...
const AIExtractPage: React.FC = () => {
  const aiExtractNavCategories: NavCategory[] = [
    {
      name: "AI Extract",
      label: "AI Extract",
      items: [
  ...
  return (
    <MissingPageTemplate
      moduleName="AI Extract"
      moduleDescription="Extract structured data from documents using AI-powered document processing."
      navCategories={aiExtractNavCategories}
      docsLink="/admin/documentation?section=ai-extract"
    />
  );
};
