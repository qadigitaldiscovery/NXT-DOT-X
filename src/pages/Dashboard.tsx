...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Mission Status Section - Modified to have 4 missions */}
      <div>
            ...
            <Card key={mission.id} className="bg-gray-800/60 border-gray-700 text-white backdrop-blur-sm hover:bg-gray-800/80 transition-colors">
              <CardHeader className="pb-2">
                <CardTitle className="flex flex-col items-center text-center">
                  <div className="text-xl font-bold text-red-400 mb-1">{mission.name}</div>
                  <div className="text-sm text-white">{mission.displayName}</div>
                </CardTitle>
                <CardDescription className="text-gray-300 text-sm text-center">Mission #{mission.id}</CardDescription>
              </CardHeader>
