...
const dataManagementNavItems: NavCategory[] = [{
  ...
  items: [{
    ...
    label: 'Supplier Costing',
    icon: Database,
    path: '/data-management/cost-management'
  }, {
    label: 'Cost Analysis',
    icon: BarChart3,
...
export const TradingSystemLayout = ({
  ...
  return <div className="flex h-screen overflow-hidden bg-gray-50">
      <SharedSidebar open={sidebarOpen} onToggle={toggleSidebar} navItems={dataManagementNavItems} />
      <div className={cn("flex flex-col flex-1 overflow-hidden", "md:rounded-tl-xl")}>
        <SharedNavbar onMenuClick={toggleSidebar} moduleTitle="Data Management" />
