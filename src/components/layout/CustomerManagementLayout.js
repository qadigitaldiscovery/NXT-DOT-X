...
const homeNavItem = { label: 'Back to Dashboard', icon: Home, path: '/master' };
export const CustomerManagementLayout = () => {
    const isMobile = useIsMobile();
    return (_jsx(SidebarProvider, { defaultOpen: !isMobile, children: _jsxs("div", { className: "flex h-screen overflow-hidden bg-gray-900", children: [_jsx(UnifiedSidebar, { items: customerNavItems, homeItem: homeNavItem, moduleTitle: "Customer Management" }), _jsxs("div", { className: "flex flex-col flex-1 overflow-hidden", children: [_jsx(SharedNavbar, { moduleTitle: "Customer Management" }), _jsx("main", { className: cn("flex-1 overflow-y-auto p-4 md:p-6", "bg-gradient-to-b from-gray-800 to-gray-900"), children: _jsx(Outlet, {}) })] })] }) }));
};
