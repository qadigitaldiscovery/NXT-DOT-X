...
const RequestyChatTester = () => {
    ...
    return (_jsx(ChatTester, { providerName: "Requesty", onSendMessage: sendMessage, placeholderText: "Enter a prompt to test the Requesty API...", isLoading: isLoading, error: error }));
};
