...
const OpenAIKeyForm = () => {
    ...
    return (_jsx(ApiKeyForm, { providerName: "OpenAI", apiKey: apiKey, isVisible: isVisible, config: config, onApiKeyChange: setApiKey, onVisibilityToggle: () => setIsVisible(!isVisible), onConfigUpdate: handleConfigUpdate, apiKeyPlaceholder: "sk-...", docsLink: {
            text: "OpenAI API Keys page",
            url: "https://platform.openai.com/api-keys"
        }, onVerify: verifyOpenAIKey, preferredModelOptions: modelOptions, initialModel: "gpt-4o-mini", footerText: "Your API key is stored securely and never exposed to the browser. Visit the OpenAI API Keys page to create a new key if needed." }));
};
