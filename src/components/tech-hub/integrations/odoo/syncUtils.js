...
export const handleToggleSync = async (id, isEnabled, updateSetting) => {
    try {
...
export const handleFrequencyChange = async (id, frequency, updateSetting) => {
    try {
...
export const handleManualSync = async (id, triggerSync) => {
    try {
