      ...
      <div className="backdrop-blur-md bg-gradient-to-r from-black/80 via-[#a51919]/70 to-black/80">
        <div className="container mx-auto flex justify-between items-center h-16 px-4">
          <div className="flex items-center">
            <span className="text-2xl font-bold text-gradient bg-gradient-to-r from-white via-white/90 to-gray-300 bg-clip-text text-transparent">DOT-X  |  BUSINESS MANAGEMENT PLATFORM</span>
          </div>
