    ...
    >
        ...
        <div className="space-y-1.5">
          {features.map((feature, index) => (
            <a 
              ...
              className="text-sm hover:underline flex items-center text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white" 
      ...
      <CardFooter className="relative z-10">
        <a 
          ...
          className={cn(
            getLinkClassName(),
            "text-sm font-medium flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
          )} 
