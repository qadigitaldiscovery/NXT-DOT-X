...
export default function PrimaryModules({ activeTab = "all", searchQuery = "" }: PrimaryModulesProps) {
  ...
  const allModules = [
    { 
      ...
      icon: <Database className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    { 
      ...
      icon: <Award className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    { 
      ...
      path: "/trading-system", 
      name: "Trading System",
      icon: <LineChart className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    { 
      ...
      path: "/social-media", 
      name: "Social Media",
      icon: <Share2 className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    { 
      ...
      path: "/tech-hub", 
      name: "Tech Hub",
      icon: <Code className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    { 
      ...
      path: "/dot-x", 
      name: "DOT-X Platform",
      icon: <Layers className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    { 
      ...
      icon: <Briefcase className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    { 
      ...
      icon: <Users className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    { 
      ...
      path: "/dashboard/rag", 
      name: "System Monitor",
      icon: <Activity className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    },
    {
      ...
      icon: <Building className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    },
    {
      ...
      name: "Analytics",
      icon: <BarChart3 className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    },
    {
      ...
      path: "/admin/security",
      name: "Security",
      icon: <Shield className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    },
    {
      ...
      icon: <Settings className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
    ...
    },
    {
      ...
      name: "Integrations",
      icon: <Zap className="h-7 w-7 stroke-[1.5] drop-shadow-sm" />,
