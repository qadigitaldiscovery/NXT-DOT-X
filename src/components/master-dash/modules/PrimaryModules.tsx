...
const PrimaryModules: React.FC = () => {
  ...
  return <section className="mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {primaryModules.map((module, index) => <Card key={module.id} className="overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 bg-white/15 backdrop-blur-sm border border-white/20 text-white shadow-[0_8px_32px_rgba(0,0,0,0.1)]">
