...
export function SetupTestUser() {
    ...
    return (_jsx(Button, { onClick: setupTestUser, disabled: isLoading, variant: "outline", size: "sm", className: "text-xs text-gray-300 border-gray-600 hover:bg-gray-800", children: isLoading ? "Setting up..." : "Setup Test User" }));
}
