...
export const AppRoutes = () => {
    return (_jsxs(Routes, { children: [
            _jsx(Route, { path: "/", element: _jsx(RootHandler, {}) }),
            _jsx(Route, { path: "/dashboard", element: _jsx(DashboardLayout, {}), 
                children: _jsx(Route, { index: true, element: _jsx(MasterDash, {}) }) }),
            DataManagementRoutes(),
            SocialMediaRoutes(),
            TechHubRoutes(),
            DotXRoutes(),
            _jsx(AllAreaRoutes, {}),
            _jsx(Route, { path: "/master", element: _jsx(Navigate, { to: "/dashboard", replace: true }) }),
